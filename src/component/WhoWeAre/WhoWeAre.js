...
const WhoWeAre = () => {
    return (
        <Container>
            ...
            <h1>Who We Are</h1>
            <h3>My Approach</h3>
            <p>I recently completed a project that was both challenging and rewarding.
                 I had to find the right tools and resources to make it happen. But with hard work and dedication, 
                 I was able to create something truly special. Check out my project and see what I accomplished.</p>
