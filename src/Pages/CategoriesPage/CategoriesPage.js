...
const CategoriesPage = () => {
  ...
  return (
    <div>
    <div style={{ backgroundImage: `url(${backgroundImage})` }} className={style.container}>
    ...
    <div>
      ...
      <div className={style.categoryImage}>
        <img src={item.imageUrl} alt={item.title} className={style.img1} />
        {index < uniqueItems.length - 1 && <img src={uniqueItems[index + 1].imageUrl}
  ...
  uniqueItems.slice(0, 2).map((item, index) => (
    <div className={style.categoryItem} key={item.id || index}>
      <div className={style.categoryImage}>
        <img src={item.imageUrl} alt={item.title} className={style.img1} />
        {index < uniqueItems.slice(0, 2).length - 1 && <img src={uniqueItems.slice(0, 2)[index + 1].imageUrl} 
